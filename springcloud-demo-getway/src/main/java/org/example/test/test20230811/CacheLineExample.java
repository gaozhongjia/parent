...
public class CacheLineExample implements Runnable{
    ...
    public final static long ITERATIONS = 500L * 1000L * 100L; private int arrayIndex = 0;
    ...
    @Override public void run() { long i = ITERATIONS + 1; while (0 != --i) { longs[arrayIndex].value = 0L; } }

    public final static class ValuePadding { protected long p1, p2, p3, p4, p5, p6, p7; protected volatile long value = 0L; protected long p9, p10, p11, p12, p13, p14; protected long p15; }
